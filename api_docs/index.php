...
<html class="no-js" lang="en">
    <head>
        <meta charset="utf-8">
        <title>Sucesos API - Documentation</title>
        <meta name="description" content="Social Media Live">
        <meta name="author" content="Claudio Dickel">
    ...
    <body>
        ...
        <div class="left-menu">
            <div class="content-logo">
                <span class="label">Sucesos - API</span>
            </div>
